...
var arabicUnicodeNormalizer = transform.Chain(norm.NFKD, norm.NFKC)

func ArabicToPhonetic(s string) string {
	normal, _, err := transform.String(arabicUnicodeNormalizer, s)
	if err == nil {
		s = normal
	}
